...
**Example (precision engineering firm):**
...
- "what is [topic]" (20/mo)
- "how does [process] work" (10/mo)
- "what is [technique]" (30/mo)
...
## EXAMPLE WORKFLOW — PRECISION ENGINEERING FIRM
...
### phrase_related results for "metal surface treatment" (us database):
- surface treatment — 1,300/mo — CPC $4.20 — Related Relevance: [high]
- metal finishing — 880/mo — CPC $3.80 — Related Relevance: [high]
- industrial coating — 720/mo — CPC $3.50 — Related Relevance: [medium]
- surface coating — 590/mo — CPC $3.10 — Related Relevance: [medium]

### phrase_questions for "metal surface treatment":
- what is metal surface treatment — 20/mo
- how does surface coating work — 0/mo
- what is thermal barrier coating — 10/mo

### Clusters identified:
1. **Surface Treatment cluster** (pillar candidate) — 8 keywords, ~1,200 combined volume
2. **Thermal Coating cluster** — 6 keywords, ~400 combined volume
3. **Industrial Finishing cluster** — 5 keywords, ~300 combined volume

### Pillar page decision:
- "Surface Treatment" cluster is largest (T1 keyword at 1,300/mo)
- "Thermal Barrier Coating" is specialist but growing (aerospace/energy sector)
- Recommend: Surface Treatment pillar first, Thermal Coating as second pillar
